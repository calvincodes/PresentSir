...
public class AddPtNameNumVenue extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(R.layout.add_pt_name_num_venue_page);
	    ...
	    course_name = (EditText) findViewById(R.id.course_name_aptnnv_et);
	    course_num = (EditText) findViewById(R.id.course_num_aptnnv_et);
	    course_venue = (EditText) findViewById(R.id.course_venue_aptnnv_et);
	    BunkMeterSwitch = (Switch) findViewById(R.id.bunk_meter_switch_aptnnv);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.acnnvm_set_tt:
        	if(course_name.getText().toString().equals("")
        		...
        		Toast.makeText(AddPtNameNumVenue.this, "Please fill all the required fields.", Toast.LENGTH_LONG).show();
        	}else
        		set_tt();
            return true;
            
        case R.id.acnnvm_reset_tt:
        	course_name.setText("Physical Training");
        	course_num.setText("");
        	course_venue.setText("SAC Ground");
        	BunkMeterSwitch.setChecked(false);
            return true;
	...
	private void set_tt() {
		...
		Intent set_tt_screen = new Intent(AddPtNameNumVenue.this, SetPT.class);
    ...
    public void onBackPressed() {
		Intent home_screen = new Intent(AddPtNameNumVenue.this, SelectCoursePtNsoToAdd.class);
