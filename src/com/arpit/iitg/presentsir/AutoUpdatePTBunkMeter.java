...
public class AutoUpdatePTBunkMeter extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		switch(hours){
			case 7: slot_to_show = "morning"; break;
			case 19: slot_to_show = "evening"; break;
		}
		...
		String set_update_msg = "No Response!\nWe assumed you bunked the "+ slot_to_show +" PT class. If you attended the class, decrease the bunk meter manually";
	...
	private void go_to_home() {
		Intent home_screen = new Intent(AutoUpdatePTBunkMeter.this, AppHome.class);
